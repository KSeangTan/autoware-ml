...
"""Legacy base classes and composition utilities for dict-based data transforms.

This module defines the dict-to-dict transform protocol used by the older NuScenes and
segmentation pipelines. New pipelines operate on ``ModelGTSample`` and use the classes in
:mod:`autoware_ml.transforms.base` instead.
"""
