...
def convert_quaternion_to_matrix(
    ...
    """
    assert isinstance(rotation_quaternion, Quaternion), "Rotation quaternion must be a Quaternion object"
    ...
    if translation is not None:
        ...
        if translation.shape != (3, 1) and translation.shape != (3, ):
            raise ValueError(
                f"Translation must be a 3x1 array, got shape {translation.shape}"
            )
